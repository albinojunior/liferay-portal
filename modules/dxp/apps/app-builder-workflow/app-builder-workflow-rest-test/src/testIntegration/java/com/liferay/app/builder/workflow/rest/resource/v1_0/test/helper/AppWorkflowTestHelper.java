...
public class AppWorkflowTestHelper {
	...
	public AppWorkflow createAppWorkflow(AppBuilderApp appBuilderApp) throws Exception {
	...
	public DDLRecord addDDLRecord(AppBuilderApp appBuilderApp, Group group) throws Exception {
	...
	private DDLRecordSet _addDDLRecordSet(DDMStructure ddmStructure, Group group)
		throws Exception {
	...
	public DDMStructureLayout _addDDMStructureLayout(
