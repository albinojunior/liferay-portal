...
import { getFiltersParam, getFilterValues } from '../../shared/components/filter/util/filterUtil.es';
...
const PerformanceByAssigneePage = props => {
	...
	const timeRangeKeys = getFilterValues(filterConstants.timeRange.key, filtersParam);
